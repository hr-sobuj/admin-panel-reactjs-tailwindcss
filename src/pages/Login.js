...
export default function Login(){
    return(
      ...
      >
        <div
          class="p-4 py-6 text-white bg-gray-900 md:w-80 md:flex-shrink-0 md:flex md:flex-col md:items-center md:justify-evenly"
        >
          <div class="my-3 text-4xl font-bold tracking-wider text-center">
            <span>Admin Panel</span>
          </div>
          <p class="mt-6 font-normal text-center text-gray-300 md:mt-0">
            Irure aute nisi reprehenderit non eiusmod officia nostrud pariatur duis in non. Cillum aliqua mollit nulla sit sint veniam ex magna ea irure. Anim exercitation amet id dolore cillum labore. Except
          </p>
          ...
          <form action="#" class="flex flex-col space-y-5">
            <div class="flex flex-col space-y-1">
              ...
              <input
                ...
                id="email"
                autofocus
                class="bg-white px-4 py-2 transition duration-300 border border-gray-300 rounded focus:border-transparent focus:outline-none focus:ring-4 focus:ring-blue-200"
              />
            </div>
            <div class="flex flex-col space-y-1">
            ...
            <div>
              <button
                type="submit"
                class="w-full px-4 py-2 text-lg font-semibold text-white transition-colors duration-300 bg-gray-700 rounded-md shadow hover:bg-gray-900 focus:outline-none focus:ring-blue-200 focus:ring-4"
              >
                Log in
              </button>
            </div>
