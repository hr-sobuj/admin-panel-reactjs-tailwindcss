  ...
  return (
    <>
      <div className="">
        ...
        <div>
          <div className="flex">
            <div className={classNames(isShowing ? "w-1/4":"w-20", "h-screen duration-300 text-white overflow-auto min-h-screen shadow-md bg-gray-900")}>
              <div className={classNames(isShowing?"flex flex-col justify-start space-y-4":"hidden")}>
                <div>
              ...
              <div className={classNames(isShowing?"hidden":"flex flex-col justify-start space-y-4")}>
                <div>
                  <div className="flex flex-col justify-center">
                    <div className="hover:bg-gray-700 text-gray-100 hover:text-white p-4">
                      <div className="flex justify-center items-center">
                        <BiMapPin className="w-7 h-7" />
                      </div>
                    </div>
                  </div>
                  <div className="flex flex-col justify-center">
